...
var periods__$1 = cljs.core.vec.call(null,(function (){var G__20500 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.call(null,(function (p1__20499_SHARP_){
return cljs.core.subs.call(null,p1__20499_SHARP_,(0),(3));
}),G__20500);
} else {
return G__20500;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__20509){
var vec__20510 = p__20509;
var t = cljs.core.nth.call(null,vec__20510,(0),null);
var pattern = cljs.core.nth.call(null,vec__20510,(1),null);
if(cljs.core._EQ_.call(null,t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__20513 = pattern;
switch (G__20513) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20513)].join('')));
...
var G__20523 = key;
var G__20523__$1 = (((G__20523 instanceof cljs.core.Keyword))?G__20523.fqn:null);
switch (G__20523__$1) {
case "millis":
return (function (p1__20515_SHARP_){
return p1__20515_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__20516_SHARP_){
return p1__20516_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__20517_SHARP_){
return p1__20517_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__20518_SHARP_){
return p1__20518_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__20519_SHARP_){
return p1__20519_SHARP_.getHours();
});

break;
case "day":
return (function (p1__20520_SHARP_){
return p1__20520_SHARP_.getDate();
});

break;
case "month":
return (function (p1__20521_SHARP_){
return p1__20521_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__20522_SHARP_){
return p1__20522_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20523__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__20525){
...
var key = first__20528;
var args = seq__20527__$1;
var G__20529 = key;
...
break;
case "ordinal-suffix":
var vec__20530 = syntax_list.call(null,(i - (1)));
var k = cljs.core.nth.call(null,vec__20530,(0),null);
...
var d = value;
var G__20537 = cljs.core.map_indexed.call(null,cljs.core.partial.call(null,cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
...
var unparser = first__20540;
var more = seq__20539__$1;
var s = "";
var d__$1 = d;
...
var unparser__$1 = first__20549;
var more__$1 = seq__20548__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__20550 = unparser__$1.call(null,s__$2,d__$2);
var s__$3 = cljs.core.nth.call(null,vec__20550,(0),null);
var d__$3 = cljs.core.nth.call(null,vec__20550,(1),null);
var G__20553 = d__$3;
var G__20554 = more__$1;
var G__20555 = s__$3;
d__$1 = G__20553;
G__20537__$1 = G__20554;
s__$1 = G__20555;
continue;
}
break;
