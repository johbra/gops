...
var G__15379 = o;
goog.object.set(G__15379,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__15381__i < G__15381__a.length) {G__15381__a[G__15381__i] = arguments[G__15381__i + 0]; ++G__15381__i;}
  args = new cljs.core.IndexedSeq(G__15381__a,0,null);
} 
...
var G__15383 = o;
goog.object.set(G__15383,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__15384__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__15384 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
return G__15384__delegate.call(this,args);};
G__15384.cljs$lang$maxFixedArity = 0;
G__15384.cljs$lang$applyTo = (function (arglist__15386){
var args = cljs.core.seq(arglist__15386);
return G__15384__delegate(args);
});
...
var G__15387 = props;
var G__15387__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__15387,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__15387);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__15387__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__15387__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__15388 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__15388,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__15388;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__15389){
...
var on_write = cljs.core.get.call(null,map__15390__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__15392_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__15392_SHARP_);
}));
} else {
return null;
}
...
var vec__15395 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__15395,(0),null);
var id = cljs.core.nth.call(null,vec__15395,(1),null);
var className = cljs.core.nth.call(null,vec__15395,(2),null);
...
var temp__5739__auto___15399 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___15399 == null)){
} else {
var key_15400 = temp__5739__auto___15399;
(jsprops.key = key_15400);
}
...
var temp__5739__auto___15401 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___15401 == null)){
} else {
var key_15402 = temp__5739__auto___15401;
(jsprops.key = key_15402);
}
...
var temp__5739__auto___15403 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___15403 == null)){
} else {
var key_15404 = temp__5739__auto___15403;
(jsprops.key = key_15404);
}
...
var G__15406 = n;
if(cljs.core._EQ_.call(null,"",G__15406)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__15406)){
return x;
} else {
...
var len__4736__auto___15409 = arguments.length;
var i__4737__auto___15410 = (0);
while(true){
if((i__4737__auto___15410 < len__4736__auto___15409)){
args__4742__auto__.push((arguments[i__4737__auto___15410]));

var G__15411 = (i__4737__auto___15410 + (1));
i__4737__auto___15410 = G__15411;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq15407){
...
break;
default:
var G__15414 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__15414;
continue;
...
var ctx = ({});
var vec__15416 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__15416,(0),null);
var derefed = cljs.core.nth.call(null,vec__15416,(1),null);
...
var G__15419 = (cljs.core.count.call(null,argv) - first_child);
switch (G__15419) {
case (0):
