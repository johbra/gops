...
var map__12621 = top_item;
var map__12621__$1 = (((((!((map__12621 == null))))?(((((map__12621.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12621.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12621):map__12621);
var file = cljs.core.get.call(null,map__12621__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__12621__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__12621__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e12620){var _e = e12620;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___12623 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___12623)){
var seen_errors_12624 = temp__5733__auto___12623;
if(cljs.core.truth_(seen_errors_12624.has(self))){
} else {
seen_errors_12624.add(self);

var temp__5735__auto___12625 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___12625)){
var sense_12626 = temp__5735__auto___12625;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_12626)].join(''));
} else {
}
}
} else {
