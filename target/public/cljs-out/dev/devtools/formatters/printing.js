...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq10081){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10082,G__10083,seq10081__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__10087_SHARP_){
return (!((cljs.core.meta.call(null,p1__10087_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__10088__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e10092){var _e__9035__auto__ = e10092;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e10094){var _e__9035__auto__ = e10094;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__10096 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__10097 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__10097);

try{var map__10098 = opts;
var map__10098__$1 = (((((!((map__10098 == null))))?(((((map__10098.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10098.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10098):map__10098);
var markup_db = cljs.core.get.call(null,map__10098__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__10096);
}});
...
var temp__5733__auto___10103 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___10103)){
var managed_print_level_10104 = temp__5733__auto___10103;
var _STAR_print_level_STAR__orig_val__10101_10105 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__10102_10106 = managed_print_level_10104;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__10102_10106);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__10100_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__10100_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__10101_10105);
}} else {
job_fn.call(null);
}
