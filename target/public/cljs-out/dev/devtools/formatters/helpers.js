...
var G__10055 = devtools.prefs.pref.call(null,v);
v = G__10055;
continue;
} else {
return v;
...
}catch (e10058){var _e__9035__auto__ = e10058;
return false;
}})();
...
}catch (e10062){var _e__9035__auto__ = e10062;
return false;
}})();
...
}catch (e10064){var _e__9035__auto__ = e10064;
return false;
}}
}
});
...
var vec__10066 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10066,(0),null);
var name = cljs.core.nth.call(null,vec__10066,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10069_SHARP_);
}),template);
});
