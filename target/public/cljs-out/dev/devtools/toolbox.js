...
if((typeof devtools !== 'undefined') && (typeof devtools.toolbox !== 'undefined') && (typeof devtools.toolbox.t_devtools$toolbox11982 !== 'undefined')){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox11982 = (function (obj,header,style,tag,meta11983){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
(devtools.toolbox.t_devtools$toolbox11982.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11984,meta11983__$1){
var self__ = this;
var _11984__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox11982(self__.obj,self__.header,self__.style,self__.tag,meta11983__$1));
}));

(devtools.toolbox.t_devtools$toolbox11982.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11984){
var self__ = this;
var _11984__$1 = this;
return self__.meta11983;
}));

(devtools.toolbox.t_devtools$toolbox11982.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL);

(devtools.toolbox.t_devtools$toolbox11982.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox11982.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
}));

(devtools.toolbox.t_devtools$toolbox11982.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox11982.getBasis = (function (){
...
(devtools.toolbox.t_devtools$toolbox11982.cljs$lang$type = true);

(devtools.toolbox.t_devtools$toolbox11982.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox11982");

(devtools.toolbox.t_devtools$toolbox11982.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"devtools.toolbox/t_devtools$toolbox11982");
}));

/**
 * Positional factory function for devtools.toolbox/t_devtools$toolbox11982.
 */
devtools.toolbox.__GT_t_devtools$toolbox11982 = (function devtools$toolbox$__GT_t_devtools$toolbox11982(obj__$1,header__$1,style__$1,tag__$1,meta11983){
return (new devtools.toolbox.t_devtools$toolbox11982(obj__$1,header__$1,style__$1,tag__$1,meta11983));
});

}

return (new devtools.toolbox.t_devtools$toolbox11982(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
}));
