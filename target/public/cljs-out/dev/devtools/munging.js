...
var o9950 = temp__5733__auto__;
var temp__5733__auto____$1 = (o9950["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o9951 = temp__5733__auto____$1;
return (o9951["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9028__auto__ = f;
return (o__9028__auto__["toString"]).call(o__9028__auto__);
} else {
return "";
}
}catch (e9952){var _ = e9952;
return "";
}});
...
try{var o__9028__auto___9954 = t;
(o__9028__auto___9954["cljs$lang$ctorPrWriter"]).call(o__9028__auto___9954,t,writer);
}catch (e9953){var __9955 = e9953;
}
...
var char_code = (function (){var o__9028__auto__ = (new String(char$));
return (o__9028__auto__["charCodeAt"]).call(o__9028__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9028__auto__ = String;
return (o__9028__auto__["fromCharCode"]).call(o__9028__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__9956 = num_code;
switch (G__9956) {
case (1):
return (185);
...
var o__9028__auto__ = String;
return (o__9028__auto__["fromCharCode"]).call(o__9028__auto__,superscript_code);
});
/**
...
}catch (e9958){var _e__9035__auto__ = e9958;
return false;
}})())){
...
var vec__9959 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__9959,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o9962 = temp__5733__auto__;
var temp__5733__auto____$1 = (o9962["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o9963 = temp__5733__auto____$1;
return (o9963["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__9966){
var vec__9967 = p__9966;
var ns_detector = cljs.core.nth.call(null,vec__9967,(0),null);
...
var G__9973 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__9974 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__9973;
remaining_tokens = G__9974;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq9964){
var G__9965 = cljs.core.first.call(null,seq9964);
var seq9964__$1 = cljs.core.next.call(null,seq9964);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9965,seq9964__$1);
}));
...
var vec__9978 = cljs.core.split_with.call(null,(function (p1__9977_SHARP_){
return cljs.core.not_EQ_.call(null,p1__9977_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__9978,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__9978,(1),null);
...
var vec__9984 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__9984,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__9984,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__9987 = cljs.core.rest.call(null,remaining_tokens);
var G__9988 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__9987;
name_tokens = G__9988;
continue;
} else {
...
var vec__9991 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__9991,(0),null);
var arity = cljs.core.nth.call(null,vec__9991,(1),null);
var vec__9994 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__9994,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__9994,(1),null);
var vec__9997 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__9997,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__9997,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__9997,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__9997,(3),null);
...
var vec__10003 = result;
var munged_ns = cljs.core.nth.call(null,vec__10003,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__10003,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__10003,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__10003,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__10003,(4),null);
var arity = cljs.core.nth.call(null,vec__10003,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__10007 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__10007,(0),null);
var args = cljs.core.nth.call(null,vec__10007,(1),null);
var vec__10010 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__10010,(0),null);
var name = cljs.core.nth.call(null,vec__10010,(1),null);
...
var G__10013 = (arity + (1));
var G__10014 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10015){
var vec__10016 = p__10015;
var arity = cljs.core.nth.call(null,vec__10016,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__10016,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__10019_SHARP_){
return cljs.core.get.call(null,arities,p1__10019_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__10020_SHARP_){
return cljs.core.drop.call(null,(2),p1__10020_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___10027 = arguments.length;
var i__4737__auto___10028 = (0);
while(true){
if((i__4737__auto___10028 < len__4736__auto___10027)){
args__4742__auto__.push((arguments[i__4737__auto___10028]));

var G__10029 = (i__4737__auto___10028 + (1));
i__4737__auto___10028 = G__10029;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10023){
var vec__10024 = p__10023;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__10024,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10021){
var G__10022 = cljs.core.first.call(null,seq10021);
var seq10021__$1 = cljs.core.next.call(null,seq10021);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10022,seq10021__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__10032__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__10032__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__10032__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__10032__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10033 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__10033,(0),null);
var fn_name = cljs.core.nth.call(null,vec__10033,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__10033,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__10033,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__10033,(4),null);
...
var o__9028__auto__ = f;
return (o__9028__auto__["getBasis"]).call(o__9028__auto__);
});
/**
...
}catch (e10037){var _e__9035__auto__ = e10037;
...
var G__10038 = (obj[cljs.core.first.call(null,path)]);
var G__10039 = cljs.core.rest.call(null,path);
obj = G__10038;
path = G__10039;
continue;
} else {
...
var _STAR_ = (function (accum,p__10040){
var vec__10041 = p__10040;
var bit = cljs.core.nth.call(null,vec__10041,(0),null);
var protocol = cljs.core.nth.call(null,vec__10041,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10044){
var vec__10045 = p__10044;
var ns = cljs.core.nth.call(null,vec__10045,(0),null);
var name = cljs.core.nth.call(null,vec__10045,(1),null);
var selector = cljs.core.nth.call(null,vec__10045,(2),null);
...
var post_process = (function (p__10049){
var vec__10050 = p__10049;
var munged_name = cljs.core.nth.call(null,vec__10050,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__10050,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__10048_SHARP_){
return (obj[cljs.core.first.call(null,p1__10048_SHARP_)]);
}),sorted_matches);
