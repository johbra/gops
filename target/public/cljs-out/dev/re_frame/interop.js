...
return [(function (){var pred__17399 = cljs.core.instance_QMARK_;
var expr__17400 = reactive_val;
if(cljs.core.truth_(pred__17399.call(null,reagent.ratom.RAtom,expr__17400))){
return "ra";
} else {
if(cljs.core.truth_(pred__17399.call(null,reagent.ratom.RCursor,expr__17400))){
return "rc";
} else {
if(cljs.core.truth_(pred__17399.call(null,reagent.ratom.Reaction,expr__17400))){
return "rx";
} else {
if(cljs.core.truth_(pred__17399.call(null,reagent.ratom.Track,expr__17400))){
return "tr";
} else {
return "other";
}
